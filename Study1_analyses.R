...
cohen.d(ft$Age~ft$nonwhite)
cohen.d(ft$Alexithymia~ft$nonwhite)
cohen.d(ft$SCARED_TOT~ft$nonwhite)
t.test(ft$SCARED_TOT~ft$nonwhite)
cohen.d(ft$CDI_TOT~ft$nonwhite)
t.test(ft$CDI_TOT~ft$nonwhite)
...
cor.test(ft$Alexithymia[which(ft$Sex=="F")],ft$Age[which(ft$Sex=="F")])
cor.test(ft$Alexithymia[which(ft$Sex=="M")],ft$Age[which(ft$Sex=="M")])
