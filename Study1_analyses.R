...
cohen.d(ft$Age~ft$Gender)
cohen.d(ft$Age~as.factor(ft$nonwhite))
t.test(ft$Age~ft$Gender)
t.test(ft$Age~ft$nonwhite)
cohen.d(ft$INC_NEEDS~ft$Gender)
t.test(ft$INC_NEEDS~ft$Gender)
cohen.d(ft$INC_NEEDS~as.factor(ft$nonwhite))
t.test(ft$INC_NEEDS~ft$nonwhite)
cohen.d(ft$Alexithymia~as.factor(ft$nonwhite))
t.test(ft$Alexithymia~ft$Gender)
cohen.d(ft$Alexithymia~ft$Gender)
t.test(ft$Alexithymia~ft$Gender)
cohen.d(ft$SCARED_TOT~ft$Gender)
t.test(ft$SCARED_TOT~ft$Gender)
...
cohen.d(ft$CDI_TOT~ft$Gender)
cohen.d(ft$PTSD_SEV_COMBINED~ft$Gender)
cohen.d(ft$PTSD_SEV_COMBINED~ft$nonwhite)
cohen.d(ft$Aggressive_Total~ft$Gender)
cohen.d(ft$Aggressive_Total~ft$nonwhite)
cohen.d(ft$Attention_Total~ft$Gender)
cohen.d(ft$Attention_Total~ft$nonwhite)
cohen.d(ft$Rule_Total~ft$Gender)
